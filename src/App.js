  ...
  return (
    <div className="body">
      <div className="page">
        ...
        <PopupWithFrom title="Новое место" name="add-card" isOpen={isAddPlacePopupOpen} onClose={closeAllPopups}>
        ...
        <PopupWithFrom title="Обновить аватар" name="edit-avatar" isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups}>
